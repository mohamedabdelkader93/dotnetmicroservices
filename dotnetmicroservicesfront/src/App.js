...
import "./App.min.css";
import { loadState, saveState, loadProfileState, saveProfileState } from "./localStorage";
...
const CategoriesView = lazy(() => import("./views/admin/category/Categories"));
const ProductsView = lazy(() => import("./views/admin/product/Products"));
const OrdersView = lazy(() => import("./views/admin/order/Orders"));
const EditProductView = lazy(() => import("./views/admin/product/EditProduct"));
const CreateProductView = lazy(() => import("./views/admin/product/CreateProduct"));
    ...
    <BrowserRouter>
      <React.Fragment>
        ...
        >
          ...
          {profileState &&
          <Routes>
<Route exact path="/admin/dashboard" element={<DashboardView/>} />
<Route exact path="/admin/products" element={<ProductsView/>} />
<Route exact path="/admin/categories" element={<CategoriesView/>} />
<Route exact path="/admin/orders" element={<OrdersView/>} />
<Route exact path="/admin/products/edit/:id" element={<EditProductView/>} />
<Route exact path="/admin/products/create" element={<CreateProductView/>} />
